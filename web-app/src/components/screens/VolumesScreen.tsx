    ...
    return (
        <div className="flex flex-col h-full relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                <div className="bg-surface/50 border border-outline/10 rounded-2xl p-6 text-center">
...
function InspectModal({ details, onClose }: { details: VolumeDetails; onClose: () => void }) {
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
            <div className="bg-surface border border-outline/20 rounded-3xl w-full max-w-2xl max-h-[80vh] overflow-hidden flex flex-col shadow-2xl">
                <div className="p-6 border-b border-outline/10 flex items-center justify-between">
                    <h2 className="text-2xl font-bold truncate pr-8">{details.name}</h2>
...
function BackupModal({ result, onClose }: { result: BackupResult; onClose: () => void }) {
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
            <div className="bg-surface border border-outline/20 rounded-3xl w-full max-w-md p-8 shadow-2xl flex flex-col items-center text-center">
                {result.success ? (
