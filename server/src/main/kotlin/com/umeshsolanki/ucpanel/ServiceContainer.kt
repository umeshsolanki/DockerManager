...
import com.umeshsolanki.ucpanel.firewall.FirewallServiceImpl
import com.umeshsolanki.ucpanel.firewall.IFirewallService
import com.umeshsolanki.ucpanel.jail.IJailManagerService
import com.umeshsolanki.ucpanel.jail.JailManagerServiceImpl
import com.umeshsolanki.ucpanel.proxy.*
import com.umeshsolanki.ucpanel.utils.CommandExecutor
import com.umeshsolanki.ucpanel.proxy.ProxyServiceImpl
import com.umeshsolanki.ucpanel.proxy.SSLServiceImpl
import com.umeshsolanki.ucpanel.kafka.*
import com.umeshsolanki.ucpanel.analytics.ClickHouseService
...
object ServiceContainer {
    // Core services
    // Core services
    val ipReputationService: com.umeshsolanki.ucpanel.ip.IIpReputationService = com.umeshsolanki.ucpanel.ip.IpReputationServiceImpl()
    ...
    // Workers
    val ipEnrichmentWorker = com.umeshsolanki.ucpanel.jail.IpEnrichmentWorker(firewallService, ipReputationService)
            ...
            override fun handle(topic: String, key: String?, value: String) {
                ...
                try {
                    ...
                    if (processedEvent.appliedRules.isNotEmpty()) {
                         ...
                         kotlinx.coroutines.GlobalScope.launch {
                             try {
                                 com.umeshsolanki.ucpanel.database.DatabaseFactory.dbQuery {
                                     com.umeshsolanki.ucpanel.database.KafkaProcessedEventsTable.insert {
