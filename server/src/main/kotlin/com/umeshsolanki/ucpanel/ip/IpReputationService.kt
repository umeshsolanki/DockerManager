package com.umeshsolanki.ucpanel.ip

import com.umeshsolanki.ucpanel.database.DatabaseFactory.dbQuery
import com.umeshsolanki.ucpanel.database.DatabaseFactory.dbQueryWithRetry
import com.umeshsolanki.ucpanel.database.IpReputationTable
import com.umeshsolanki.ucpanel.database.IpReputation
...
import com.umeshsolanki.ucpanel.kafka.IpReputationEvent
        ...
        private fun publishToKafka(event: IpReputationEvent) {
            try {
                ...
                if (AppConfig.settings.clickhouseSettings.enabled) {
                    com.umeshsolanki.ucpanel.analytics.ClickHouseService.logReputationEvent(event)
                }
            } catch (e: Exception) {
